...
language.Add( "proj_shotgunrocket", "Rocket" )
language.Add( "proj_ball", "SMG Grenade" )
language.Add( "prop_fortwars", "Prop" )
language.Add( "fw_turret_ground", "Turret" )
language.Add( "fw_Core", "Core" )
language.Add( "worldspawn", "Stupidity" )
language.Add( "trigger_hurt", "Extreme Failure" )
 ...
 killicon.AddFont( "weapon_fw_smg", 		"HL2MPTypeDeath", 	"/",	Color_Icon )
 killicon.AddFont( "fw_turret_ground", 		"HL2MPTypeDeath", 	"/",	Color_Icon )
 killicon.AddFont( "prop_fortwars", 		"HL2MPTypeDeath", 	"9", 	Color_Icon )
 killicon.AddFont( "weapon_fw_rifle", 		"HL2MPTypeDeath", 	"1", 	Color_Icon )
 killicon.AddFont( "weapon_fw_pistol", 		"HL2MPTypeDeath", 	"-", 	Color_Icon )
 killicon.AddFont( "proj_shotgunrocket", 		"HL2MPTypeDeath", 	"7", 	Color_Icon )
 killicon.AddFont( "proj_ball", 	"HL2MPTypeDeath", 	"8", 	Color_Icon )
 ...
 local function RecvDestroyed( message )

 	local victim 	= message:ReadString()
 	local inflictor	= message:ReadString()
	local name	= message:ReadString()
	local teamx	= message:ReadShort()
	local team	= message:ReadShort()

 	GAMEMODE:AddDeathNotice( name, teamx, inflictor, victim, team )

 end

 usermessage.Hook( "EntDestruction", RecvDestroyed )
